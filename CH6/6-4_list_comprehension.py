...
[g for g in grades if g >= 60] 是一個列表生成式（List Comprehension）的語法。讓我詳細解釋一下：
...
# 在你提供的例子中，pass_grades 就是這個新的列表，其中包含了 [100, 90, 66, 80, 82, 77] 這些成績。這個列表生成式讓我們可以方便地過濾出符合特定條件的元素，並且以簡潔的方式創建新的列表。
